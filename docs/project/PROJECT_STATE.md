...
25. **Sprint 2 — BLOCKERS (must precede any release; each needs a CCR + major bump).** Tracked as `SEIP-BLOCK-001/002/003` on `.ai-team/task-board.yaml` (CCR-014/015/016):
