...
- `docs/decisions/**`
- `docs/project/**`
- `.ai-team/**` (agents may edit only `file-locks.yaml` and their own `handoffs/`)
- `.github/**`
- `scripts/orchestration/**`

## Document Precedence (ADR-0002)
ADR > `module-ownership.yaml` > `task-board.yaml` > agent instruction files > narrative docs.
Correct the lower document to match the higher, never the reverse.
